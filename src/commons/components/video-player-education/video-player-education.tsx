...
import styles from './video-player-education.module.scss';

export interface VideoEducationItemPropTypes {
  isShowLogo?: boolean;
  data: VideoItemType;
  width?: string;
  height?: string;
...
export class VideoPlayerEducation extends Component<VideoEducationItemPropTypes> {
  videoRef: any;
  state = {
  ...
  constructor(props: VideoEducationItemPropTypes) {
    super(props);
